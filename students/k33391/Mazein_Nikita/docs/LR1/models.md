...
Этот модуль содержит описания моделей данных для задач, расписаний, напоминаний и пользователей.

## Описание

Модуль содержит описания классов моделей данных, используемых в приложении. Реализован функционал 1:M и M:M.
